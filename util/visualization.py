...
def get_colored_point_cloud_feature(pcd, feature, voxel_size):
  tsne_results = embed_tsne(feature);print("#####tsne#####");print(tsne_results.shape);print(tsne_results)

  color = get_color_map(tsne_results)#; print(color, color.shape)
  pcd.colors = o3d.utility.Vector3dVector(color)#;print(pcd.colors)
